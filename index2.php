...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="index2.php">
                EscoART
            </a>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tienda/index.html"><img src="./assets/img/category_img_01.png" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Colores</h5>
                <p class="text-center"><a class="btn btn-success">Comprar Ahora</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tienda/index.html"><img src="./assets/img/category_img_02.png" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Cuadernos</h2>
                <p class="text-center"><a class="btn btn-success">Comprar Ahora</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="tienda/index.html"><img src="./assets/img/category_img_03.png" class="rounded-circle img-fluid border"></a>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="tienda/index.html" class="h2 text-decoration-none text-dark">Caja de Boligrafos Offi-Esco</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="tienda/index.html" class="h2 text-decoration-none text-dark">Caja de colores Prismacolor</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="tienda/index.html" class="h2 text-decoration-none text-dark">Cartuchera multiuso Totto</a>
                            <p class="card-text">

...
if ($_POST["operacion"] == "Editar") {
    $stmt = $conexion->prepare("UPDATE usuario SET Nom_Usuario=:Nom_Usuario, Primer_Apellido=:Primer_Apellido, Segundo_Apellido=:Segundo_Apellido, Correo_Usuario=:Correo_Usuario WHERE id=:id");
    $resultado = $stmt->execute(
        array(
            ':Nom_Usuario'  => $_POST["nombre"],
            ':Primer_Apellido'  => $_POST["primerape"],

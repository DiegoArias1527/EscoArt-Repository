...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2024 a las 03:12:49
...
INSERT INTO `productos` (`Id_Producto`, `Nom_Producto`, `Precio_Producto`, `Desc_Producto`, `Id_Categoria`, `Id_Proveedor`, `activo`) VALUES
(11001, 'Tijeras', 4500, '', 1, 101, 0),
(11002, 'Marcadores', 1000, '', 1, 101, 0),
(11003, 'Caja lapiceros Rojos', 7000, '', 1, 102, 0),
(11004, 'Carpeta plastica de colores', 2500, '', 1, 101, 0),
(11005, 'Paquete X8 marcadores de color', 15000, '', 1, 102, 0),
(11006, 'Cuaderno 100 hojas 1', 2500, '', 2, 103, 0),
(11007, 'Cartuchera', 15000, '', 2, 103, 0),
(11008, 'Cuaderno 100 hojas 2', 2500, '', 2, 103, 0),
(11009, 'Tajalapices', 3000, '', 2, 103, 0),
(11010, 'Bloc hojas cuadriculadas', 5000, '', 2, 103, 0),
(11011, 'Borrador miga de pan', 1000, '', 2, 103, 0),
(11012, 'Caja de colores', 12500, '', 2, 103, 0),
(11013, 'Compas ', 4600, '', 2, 103, 0),
(11014, 'Paquete pinceles', 10000, '', 3, 104, 0),
(11015, 'Pinturas Oleo', 25000, '', 3, 104, 0),
(11016, 'Cuaderno de dibujo Norma', 17000, '', 3, 104, 0),
(11017, 'Lapices de Grafito', 4000, '', 3, 104, 0);
...
INSERT INTO `usuario` (`Id_Usuario`, `Nom_Usuario`, `Primer_Apellido`, `Segundo_Apellido`, `Correo_Usuario`, `Contraseña`, `id_cargo`) VALUES
(115, 'Diego', 'Arias', 'Torres', 'diegoarias@gmail.com', '$2y$10$Uc236LlN/rYWtvefL2owkOWFuuknmouvE4KURvaAtJj4t7oEvq0Q.', 2),
(116, 'Admin', 'Admin', 'Admin', 'admin@admin.com', '$2y$10$1o4aHksCrNe0SDmrOOoMMe77Q0xeGZp5DGafly50MQoFri4KLwFb.', 1);
...
--
ALTER TABLE `usuario`
  MODIFY `Id_Usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Es el valor unico que tiene cada usuario', AUTO_INCREMENT=117;

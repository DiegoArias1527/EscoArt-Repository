...
if (isset($_POST['update_profile'])) {
    ...
    $old_pass = mysqli_real_escape_string($conex, trim($_POST['old_pass']));
    ...
    if (password_verify($old_pass, $old_pass_db)) {
        if (!empty($new_pass) && !empty($confirm_pass) && $new_pass === $confirm_pass) {
            ...
            echo '
            <script>
                alert("La nueva contraseña y la confirmación no coinciden o están vacías");
            </script>
            ';
        }
    } else {
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="password" name="old_pass" placeholder="ingrese la contraseña actual" class="box">

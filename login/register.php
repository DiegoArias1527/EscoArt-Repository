    ...
    <div class="container-form register">
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form action="registrar.php" method="post" class="form" enctype="multipart/form-data">
                   <label>
                    <i class='bx bx-user' ></i>
                    <input type="text" name="nombre" pattern="[A-Za-z]{1,15}" placeholder="Nombres" required>
                </label>
                <label>
                    <i class='bx bx-user' ></i>
                    <input type="text" name="primerape" pattern="[A-Za-z]{1,20}" placeholder="Primer Apellido"required>
                </label>
                <label>
                    <i class='bx bx-user' ></i>
                    <input type="text" name="segundoape" pattern="[A-Za-z]{1,20}" placeholder="Segundo Apellido"required>
                </label>
